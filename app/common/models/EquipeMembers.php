...
class EquipeMembers extends \Phalcon\Mvc\Model
{
    ...
    public function initialize()
    {
        ...
        $this->belongsTo('id', '\Equipe', 'idChef', ['alias' => 'Equipe']);
    }
     ...
     * @return EquipeMembers[]|EquipeMembers|\Phalcon\Mvc\Model\ResultSetInterface
     */
     ...
     *
     * @param mixed $parameters
     * @return EquipeMembers|\Phalcon\Mvc\Model\ResultInterface|\Phalcon\Mvc\ModelInterface|null
     */
